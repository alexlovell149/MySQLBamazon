...
connection.query("SELECT * FROM products", function(err, results) {
  ...
  inquirer.prompt([
	...
	if (chosenStock < chosenProduct.stock_quantity) {
		console.log("Your total for " + "(" + chosenStock + ")" + chosenProduct.product_name + " is: "
			+ "$" + chosenProduct.price * chosenStock);
    ...
    // else if (answer.quit === "n".toLowerCase()) {
    // 		console.log(answer.quit !== connection.end());
    // 		} 
    else {
